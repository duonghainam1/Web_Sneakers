            ...
            <div className="lg:mx-28">
                ...
                <div className="grid lg:grid-cols-3 gap-4">
                    <div className="bg-white p-5">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae, inventore sequi.
                            Quasi, deserunt iusto hic beatae architecto reprehenderit laudantium fuga, porro
                            accusantium ducimus atque vero consectetur voluptas recusandae non obcaecati?
                        </p>
                        <div className="flex items-center mt-4">
                            <img src="../img/avatar-hai.jpg" className="w-14 h-14 rounded-full border border-red-600 mr-3" alt="" />
                            <div>
                                <h4 className="font-medium">Leslie Alexander</h4>
                                <p className="text-gray-300 text-xs">Model</p>
                            </div>
                        </div>
                    </div>
                    <div className=" bg-white p-5">
